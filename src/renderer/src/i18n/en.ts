...
export const en: Record<I18nKey, string> = {
  ...
  'tool.mixdown.desc': 'Mix a "base" track with other tracks',
  ...
  'mixdown.empty': 'Drop files or folders here, then pick tracks below to build a mix card',
  'mixdown.base': 'Base',
  'mixdown.ingredients': 'Ingredients',
  'mixdown.pickBase': 'Click a track below to set as base',
  'mixdown.pickIngredient': 'Click a track below to add',
  'mixdown.cardTitle': 'Mix card {n}',
  'mixdown.baseBadge': 'card{n} base',
  'mixdown.ingredientBadge': 'card{n} ingredient',
