export const zh = {
  ...
  'tool.mixdown': '混音合併',
  'tool.mixdown.desc': '把其他音軌混進一條主音軌',
  ...
  'mixdown.empty': '把檔案或資料夾拖到這裡,再挑音軌組成混音',
  'mixdown.base': '主音軌',
  'mixdown.ingredients': '混入',
  'mixdown.pickBase': '點此,再選主音軌',
  'mixdown.pickBaseActive': '↑ 點上方音軌設為主音軌',
  'mixdown.pickIngredient': '點此,再選要混入的音軌',
  'mixdown.pickIngredientActive': '↑ 點上方音軌混入',
  'mixdown.instrMain': '選一條主音軌(它決定輸出:影片軌→輸出影片,音訊軌→輸出音訊檔)',
  'mixdown.instrMixin': '選要混進主音軌的音軌',
  'mixdown.cardTitle': '混音 {n}',
  'mixdown.baseBadge': '{n} 主',
  'mixdown.ingredientBadge': '{n} 混',
