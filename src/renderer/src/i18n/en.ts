...
export const en: Record<I18nKey, string> = {
  ...
  'tool.mixdown.desc': 'Mix other tracks into one main track',
  ...
  'toast.noMixCards': 'At least one mix card needs a base and an ingredient',
  'mixdown.empty': 'Drop files or folders here, then pick tracks to build a mix',
  'mixdown.base': 'Main',
  'mixdown.ingredients': 'Mix in',
  'mixdown.pickBase': 'Click here, then pick the main track',
  'mixdown.pickBaseActive': '↑ pick a track above as the main',
  'mixdown.pickIngredient': 'Click here, then pick tracks to mix in',
  'mixdown.pickIngredientActive': '↑ pick tracks above to mix in',
  'mixdown.instrMain': 'Pick a main track (it sets the output: video track → video, audio track → audio file)',
  'mixdown.instrMixin': 'Pick tracks to mix into the main',
  'mixdown.cardTitle': 'Mix {n}',
  'mixdown.baseBadge': '{n} main',
  'mixdown.ingredientBadge': '{n} in',
  ...
  'settings.tab.analysis': 'Loudness Analysis',
  'settings.analysis.metrics': 'Metrics to analyze',
  'settings.analysis.load': 'Analysis load',
  'settings.analysis.extraPass': 'extra pass',
  'settings.analysis.hint': 'More metrics = slower; ones marked "extra pass" read the file an additional time',
  ...
  'settings.accent.customHint': 'Custom color (right-click to delete)',
